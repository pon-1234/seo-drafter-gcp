...
BEGINNER_PROMPT_LAYERS = PromptLayerDefaults(
    ...
    developer=(
        ...
        "具体例は2つ以上、実際の体験やケーススタディを含めてください。"
        "出典は各セクション1〜2本に厳選し、一次情報を優先してください。"
...
INTERMEDIATE_PROMPT_LAYERS = PromptLayerDefaults(
    ...
    developer=(
        ...
        "出典は各セクション1〜2本に厳選し、一次情報を優先してください。重複URLは削除します。"
        "具体的な数値・事例は2点以上提示してください。"
